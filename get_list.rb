...
source_url = 'http://sfbay.craigslist.org/search/apa/eby?zoomToPosting=&altView=&query=&srchType=A&minAsk=&maxAsk=2500&bedrooms=2&nh=54'
page = Nokogiri::HTML(open(source_url).read, nil, 'UTF-8')
links = page.xpath("//body/article[@id='pagecontainer']/section[@class='body']/div[@id='toc_rows']/div[@class='content']/p[@class='row']/a[@href]")
