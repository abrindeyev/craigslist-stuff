...
links = page.xpath("//body/section[@id='pagecontainer']/div[@class='middle']/form[@id='searchform']/div[@class='rightpane']/div[@class='content']/span[@class='rows']/p[@class='row']/a[@href]")
